...
class SortingGameSelectScreen extends StatefulWidget {
  const SortingGameSelectScreen({super.key});

  @override
  State<SortingGameSelectScreen> createState() => _SortingGameSelectScreenState();
}

class _SortingGameSelectScreenState extends State<SortingGameSelectScreen> {
  ...
  void initState() {
    ...
    _storageService.init().then((_) {
      if (mounted) {
        setState(() {
          _progress = _storageService.getOrCreateGameProgress('sorting_game');
        });
